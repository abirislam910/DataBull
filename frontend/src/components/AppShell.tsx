    ...
    <div className="min-h-screen bg-bg">
      <header className="border-b border-border bg-surface">
        <div className="mx-auto flex h-14 max-w-7xl items-center gap-8 px-6">
          <NavLink
            to="/dashboard"
            className="flex items-center gap-2 rounded-md px-3 py-2 text-chrome transition-colors text-text-secondary hover:bg-surface-hover hover:text-text"
          >
          ...
          <div className="ml-auto flex items-center gap-3">
            {user ? (
              <span className="font-mono text-cell text-text-muted">{user.email}</span>
            ) : null}
